	...
	*/
	...
	function city_state_shortcode( $atts ){
		...
		<div id="msg-container" class="service-area">
			...
			<div class="msg-head"> 
				<div class="heading lit-blue-txt hr-line wow fadeInDown uppercase animated" >Client Success Around the Country</div>
			 <div class="butonimg single-faq-head"><h3>See how we've helped other small businesses with SEO:</h3></div> 
			</div>		
