...
<?php
   ...
   */
   global  $footer_id;
   ?>
<div class="footer-form-section gravity-form home-bottom-form">
...
<div id="offices">
   ...
   <div id="footer" class="grey-txt footer-bottom wow fadeInUp">
      <div class="content-center">
         ...
         <div class="footer-links"> &copy; <?php echo date('Y'); ?> <strong>Blue Corona</strong>&nbsp;&nbsp;    | <a href="<?php echo $link['url'] ?>"><?php echo $link['title'] ?></a> | <a href="https://www.bluecorona.com/privacy">Privacy Policy</a> | <a href="javascript:void(0)" class="disclaimer-btn">Disclaimer</a>
         </div>
         <?php } ?>
         <?php }  ?>
         <?php if ( wp_is_mobile() ) {  ?>
   ...
   <div class="popup_content">
      <div class="modal-content">
         <div class="modal-header">
            ...
            <img src="https://www.bluecorona.com/wp-content/themes/bluecorona-2017/images/multiply.png">
            </button>
         </div>
         <div class="modal-body">
            <p>The information on this website is for informational purposes only; it is deemed accurate but not guaranteed. It does not constitute professional advice. All information is subject to change at any time without notice. <a href="https://www.bluecorona.com/contact-us">Contact us</a> for complete details. </p>
         </div>
      </div>
   </div>
...
<script>
   jQuery("#gform_81").submit(function(event){
    ...
    window.open('https://www.bluecorona.com/wp-content/uploads/2017/08/HTTPS-Is-Good-For-SEO-Downloadable.pdf', '_blank');
   });
...
<script>
   jQuery("#gform_78").submit(function(event){
    event.preventDefault();
    window.open('https://www.bluecorona.com/wp-content/uploads/2017/07/Facebook-Targeting-Lead-Magnet.pdf', '_blank');
   });
   jQuery("#gform_79").submit(function(event){
     event.preventDefault();
     window.open('https://www.bluecorona.com/wp-content/uploads/2017/07/Lead-Magnet-6-Ways-to-Improve-Your-Email-Open-Rate.pdf', '_blank');
   });
   jQuery("#gform_80").submit(function(event){
     event.preventDefault();
     window.open('https://www.bluecorona.com/wp-content/uploads/2017/07/BC-E-book-How-to-Get-Your-Business-on-the-First-Page-of-Google.pdf', '_blank');
   });
   jQuery("#gform_86").submit(function(event){
     event.preventDefault();
     window.open('https://www.bluecorona.com/wp-content/uploads/2017/11/GAC-Case-Study_17x11_R5_Digital.pdf', '_blank');
   });
</script>
<script>
   jQuery(document).ready(function(){        
