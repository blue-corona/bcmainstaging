<section class="as-seo-faq">
   <div class="content-center">
      ...
      <?php if (have_rows('add_digital_marketing_services_faq', 19280 ) ) : ?>
         <?php while (have_rows('add_digital_marketing_services_faq', 19280 ) ) : the_row() ; ?>
...
.as-seo-faq .single-faq-head h3::before, .as-seo-faq .single-faq-head h3::after {
  background: #fff;
}
</style>