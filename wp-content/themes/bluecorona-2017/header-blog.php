...
<div class="fixed-header-sec">
    <div class="mobile top-phone"><a href="tel:8006964690"><i class="fa fa-mobile" aria-hidden="true"></i></a><a class="top-white-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php bloginfo( 'template_directory' ); ?>/images/top-white-logo.png" alt="Blue corona Logo"/></a>
  <div class="svg-bar"><span>Menu</span></div>
  
  </div>
  <div class="lit-blue-bg pop-btn"><span class="contact-ipad">Let’s Talk</span> <span class="mobile-ipad">Contact Us</span>
  </div>
    ...
    <?php wp_nav_menu( array( 'menu' => 'Header Menu Mobile', 'after' => '<span></span>', ) ); ?>
...
<!--          <div class="phone-rit">
  ...
  <div class="form-heading"><span class="form-icon"></span>Need Help With Your Marketing?</div>
