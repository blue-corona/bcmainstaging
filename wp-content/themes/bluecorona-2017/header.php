...
<![endif]-->
<!--[if !(IE 6) & !(IE 7) & !(IE 8)]><!-->
<html <?php language_attributes(); ?> id="sidebar-collapse-container">
<!--<![endif]-->
<head>
...
<?php $post_month = get_the_date( 'F' );  ?>
<?php $post_day = get_the_date( 'j' );  ?>
<script>
dataLayer = [{
'blogAuthor': '<?php echo $author ;?>',
'pubDay': '<?php echo $post_day; ?>',
'pubMonth': '<?php echo $post_month; ?>',
'pubYear': '<?php echo $post_year; ?>'
}];
</script>
<!-- Google Tag Manager -->
...
<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_directory' ); ?>/css/fonts-common.css" />
<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_directory' ); ?>/css/sub-style.css" />
<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_directory' ); ?>/css/retargeted-page.css" />
<link rel="pingback" href="<?php bloginfo( 'pingback_url' ); ?>" />
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/bc-2017/style.css">
<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/bc-2016/style.css">
<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_directory' ); ?>/css/style-2019.css" />

<?php
//if ( wp_is_mobile() ) {
?>
<link rel="stylesheet" media="(max-width: 1024px)" href="<?php echo get_template_directory_uri(); ?>/css/max-width-1024.css" type="text/css">
...
<!-- Custom CSS for certain pages -->
<?php if (is_page(16071)) { ?>
<style>.testimonials-new-sec.competitive-sec .testimonials-new-content {display:none;}</style>
<?php } ?>

<?php if (is_single(14790)) { ?>
<style>
@media screen and (min-width: 900px) {
	.service-local-listing .local-listing-col {min-height:420px !important;}
}
</style>
<?php } ?>
...
<style>
@media screen and (min-width: 900px) {
	.service-local-listing .local-listing-col {min-height:580px !important;}
}
</style>
<?php } ?>
...
<style>
@media screen and (min-width: 900px) {
	.service-local-listing .local-listing-col {min-height:510px !important;}
}
</style>
<?php } ?>

<?php if (is_single(15216)) { ?>
<style>
@media screen and (min-width: 900px) {
	.service-local-listing .local-listing-col {min-height:410px !important;}
}
</style>
<?php } ?>

<?php if (is_single(14835)) { ?>
<style>
@media screen and (min-width: 900px) {
	.service-local-listing .local-listing-col {min-height:360px !important;}
}
</style>
<?php } ?>


<?php if (is_page(16233)) { ?>
	<!-- Start of bluecorona Zendesk Widget script -->
<script id="ze-snippet" src="https://static.zdassets.com/ekr/snippet.js?key=69256238-618c-4810-9996-f2059c67374a"> </script>
<!-- End of bluecorona Zendesk Widget script -->
<?php } ?>	
</head>
...
<body <?php body_class('media-body'); ?> class="fixed-height">
...
<?php //if ( is_single(11293) ) { ?>
    <!--div class="mobile top-phone"><a href="tel:<?php //echo preg_replace('/[^0-9]/', '', $phone_fire);?>"><?php //echo $phone_fire; ?></a>
		
	</div-->
<?php // } else { ?>
<div class="fixed-header-sec">
    <div class="mobile top-phone"><a class="top-white-logo" href="<?php echo esc_url( home_url( '/' ) ); ?>"><img class="blue-logo-col" src="<?php bloginfo( 'template_directory' ); ?>/images/logo-no-tagline.svg" alt="Blue corona Logo"/>
	
	<img class="white-logo-col" src="<?php bloginfo( 'template_directory' ); ?>/images/logo-no-tagline-white.svg" alt="Blue corona Logo"/>
	</a>
	<div class="fixed-header-sec-inner">
	<a class="phn-icon" href="tel:8006964690"><i class="fa fa-phone" aria-hidden="true"></i></a>
	<div class="svg-bar"></div>
	</div>
	</div>
	<div class="lit-blue-bg pop-btn">
		<span class="contact-ipad">Contact Us</span> 
		<span class="mobile-ipad">
			<span class="hide-with-nav">Contact Us</span>
			<span class="show-with-nav">Let’s Talk</span>
		</span>
		
	</div>
		<div id="header-nav-outer" class="mobile-ipad-nav">
        <div id="header-nav" class="purple-bg"><div class="content-center">
			<div class="mobile-expand-nav">
			<div class="search-box-new mobile-show">
<form method="get" id="searchform2" action="<?php bloginfo('home'); ?>/">
                  <input data-id="search-input2" type="text" size="put_a_size_here" name="s" id="s2" class="search-input" value=""/>
                  <input type="submit" id="searchsubmit2" value="submit" class="search-btn " />
               </form></div>
...
<div class="search-box-new desktop-show">
<form method="get" id="searchform" action="<?php bloginfo('home'); ?>/">
                  <input data-id="search-input" type="text" size="put_a_size_here" name="s" id="s" class="search-input" value=""/>
                ...
                <div class="phone">
					...
					<div class="phone-lft">
						...
						<?php } else { ?>
							<div class="phone-lft-btm"><i class="fa fa-phone" aria-hidden="true"></i><span>(800) 696-4690</span></div>
						<?php } ?>
...
<!--					<div class="phone-rit">
		...
		<?php if(!is_singular("hvac") && !is_page_template("template-landing.php") ) {?> 
			...
			<div id="header-nav-outer" class="desktop-navigation">
        <div id="header-nav" class="purple-bg"><div class="content-center">
			<div class="lit-blue-bg pop-btn"><span class="contact-ipad">Let’s Talk</span> <span class="mobile-ipad">Contact Us</span></div>
			<?php ubermenu( 'main' , array( 'menu' => 363 ) ); ?>
			</div></div></div>
			
		<div class="content-center new-container popup-mobile">
		<div class="pop-form gravity-form">
	
	<div class="close-btn form-close"></div>
	<div class="form-center">
	<div class="form-heading"><!--<span class="form-icon"></span>-->Need Help<span> With Your Marketing?</span></div>
