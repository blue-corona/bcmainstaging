...
<div class="content-center">
	...
	<div class="back-post"><a class="back" href="<?php echo esc_url( home_url( '/' ) ); ?>testimonials/"> Back to Testimonials</a></div>
...
?>
    ...
    <?php $description = get_the_author_meta( 'description' , 2); ?>

    <div id="personal-information">

    	<p><strong>About The Author: </strong><?php echo $description; ?>

        <br><a href="<?php echo get_author_posts_url(2); ?>">View more blogs by <span style="text-transform:capitalize"><?php the_author_meta( 'display_name', 2 ); ?></span></a>
