<?php
/**
* Template Name: BTO Forum Template
*
         ...
         <div class="columns-1" id="content-columns">
            <div class="sub-inner-content">
			   ...
			   <div class="vistage-right">
					<div class="chief-outsiders-logo bto-logo"><a href="#"><img src="<?php echo esc_url(home_url('/'));?>/wp-content/uploads/2018/01/acca-1.31.18.png" alt=""/></a>
					</div>
                ...
                <h3 class="divaligncenter">DIGITAL COMPETITIVE ANALYSIS INQUIRY</h3>
					...
					<div class="contact-form sub-content-form">
						...
						<?php echo do_shortcode('[gravityform id="85" title="false" description="false" tabindex="7"]'); ?>
					...
					<div class="g-partner-logo g-partner-logo-desktop">
						<ul>
							...
							<li><a href="#"><img src="<?php echo esc_url(home_url('/'));?>wp-content/uploads/2017/10/acca-logo-1.png" alt=""/></a></li>
						</ul>
					</div>
					</div>
