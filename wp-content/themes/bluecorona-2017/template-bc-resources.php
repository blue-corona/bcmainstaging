<?php
/**
 * Template Name: BC Resources Template
 *
...
<div id="sub-container bc-resorce">
   ...
   <div class="resour-ces">
   <div class="content-center">
   <div class="title-head">Resources</div>
   <p>Browse our wealth of resources to help your business grow faster.</p>
   ...
   <?php if(have_rows('resources') ) :
	...
	<li>
   <a class="resources-title" href="<?php the_sub_field('add_link')?>"><?php the_sub_field('title')?></a>
  
    <a class="outer-icon" href="<?php the_sub_field('add_link')?>"><img src="<?php the_sub_field('icon')?>" alt="<?php the_sub_field('alt_text')?>"/></a>
	
   <div class="btn-resource"><a href="<?php the_sub_field('add_link')?>"><?php the_sub_field('link_text')?></a></div>
   </li>
    <?php $cnt++; endwhile;
endif;?>
</ul>
	...
	<div class="featured-blogs featured-blogs2">
		<div class="content-center">
			<div class="title-head">Related Information</div>
