...
<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_directory' ); ?>/css/style-landing-2020.css" />
<?php
//if ( wp_is_mobile() ) {
?>
...
<?php // } else { ?>
<div class="fixed-header-sec customclass">
...
<!--					<div class="phone-rit">
	...
	<?php echo do_shortcode('[gravityform id="108" title="false" description="false" ajax="true" tabindex="32"]'); ?>
                	</div></div></div>
