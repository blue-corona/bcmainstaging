...
<div class="footer-form-section gravity-form home-bottom-form landing-form-footer">
	<div class="content-center">
   <div class="form-center"> 
    <div class="icon"></div>
    <div class="form-heading"><strong>Get Started</strong>with Blue Corona Today</div>
    <?php echo do_shortcode('[gravityform id="109" title="false" description="false"]'); ?>
  </div>
</div>
</div>
  ...
  <div class="content-center">
    <?php if ( !wp_is_mobile() ) {  ?>
      ...
      <?php } else { ?>
       ...
       <div class="footer-links"> &copy; <?php echo date('Y'); ?> <strong>Blue Corona</strong>&nbsp;&nbsp; | <a href="https://bcmainstaging.wpengine.com/privacy">Policy</a>
	   <span>The information on this website is for informational purposes only; it is deemed accurate but not guaranteed. It does not constitute professional advice. All information is subject to change at any time without notice. Contact us for complete details.</span>
       </div>
   ...
   <?php if ( wp_is_mobile() ) {  ?>
    ...
    <?php } else { ?>
      <?php $link = get_field('sitemap_link',  $footer_id) ; ?>
      <div class="footer-links footer-mobile-links"> &copy; <?php echo date('Y'); ?> Blue Corona&nbsp;&nbsp; <a href="<?php echo $link['url'] ?>"><?php echo $link['title'] ?></a> | <a href="#">Policy</a>  <br> <span>The information on this website is for informational purposes only; it is deemed accurate but not guaranteed. It does not constitute professional advice. All information is subject to change at any time without notice. Contact us for complete details.</span></div>
    <?php } ?>
  <?php }  ?>
...
jQuery('.featured-slider ul').slick({
    autoplay: true,
    arrows: false,
    slidesToShow: 4,
    slidesToScroll: 1,
