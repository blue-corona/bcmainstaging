	...
	<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		<header class="entry-header">
			<hgroup>
				...
				<h3 class="entry-format"><?php _e( 'Status', 'bluecorona2015' ); ?></h3>
			</hgroup>
		...
		<div class="entry-content">
			<div class="avatar">
				<?php
				/**
				 * Filter the Bluecorona 2015 status avatar size.
				 *
				 * @since Bluecorona 2015 1.0
				 *
				 * @param int The height and width avatar dimensions in pixels. Default 65.
				 */
				echo get_avatar( get_the_author_meta( 'ID' ), apply_filters( 'bluecorona2015_status_avatar', 65 ) );
				?>
			</div>
