<?php
/**
* Template Name: ACCA Signup Thank You Template
*
...
<div class="chief-thanku">
  <div class="thanku-banner">
   ...
   <?php if (have_rows( 'banner_overlay_content' ) ) : 
	...
	<div class="chief-outsiders-logo bto-logo"><a href="#"><img src="<?php echo esc_url(home_url('/'));?>/wp-content/uploads/2018/05/ACCA-Logo-small.png" alt=""/></a>
					</div>
	<?php endwhile;
	endif;?>
</div>
