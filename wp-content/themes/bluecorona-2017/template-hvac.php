               ...
               <div class=" columns-block columns-1">
                  <div class="portfolioContainer-main masonry-gutter">
                     <?php
                        ...
                        query_posts(array(
                        	'post_type'      => 'hvac', // You can add a custom post type if you like
                        	'paged'          => $paged,
                        	'posts_per_page' => 12,
							'order'            => 'DESC',
                        ));
                     ...
                     <?php
                        $terms = get_the_terms( $post->ID , 'hvac_categories' );
...
<?php } ?>
                           <div class="portfolio-overlay">
                              <div class="portfolio-overlay-inner">
                                 ...
                                 <div class="columns-lnk link "><a href="<?php the_permalink(); ?>" target="_blank">Read</a></div>
                              </div>
                           </div>
                        </div>
                        <div class="portfolio-title">
                           <div class="sub-head drk-txt"><?php the_field('title'); ?></div>
						   <?php
								$givchars = 70; 
