<section class="as-seo-faq">
   <div class="content-center">
      <div class="faq-strt sub-inner-content">
         <div class="sec-title"><?php the_field('add_s_faq_type');?> </div>
      <?php if (have_rows('add_service_faq') ) : ?>
         <?php while (have_rows('add_service_faq') ) : the_row() ; ?>
            <div class="single-faq-wrap  wow fadeInDown">
               <div class="tit-as single-faq-head custom-heading"><h3><?php the_sub_field('add_faq_title') ; ?></h3></div>
