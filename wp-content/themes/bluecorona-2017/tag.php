			...
			<?php if ( have_posts() ) : ?>
				...
				<header class="page-header">
					<h1 class="page-title"><?php
						printf( __( 'Tag Archives: %s', 'bluecorona2015' ), '<span>' . single_tag_title( '', false ) . '</span>' );
					?></h1>
					...
					<?php
						...
						if ( ! empty( $tag_description ) ) {
							/**
							 * Filter the default Bluecorona 2015 tag description.
							 *
							 * @since Bluecorona 2015 1.0
							 *
				...
				<?php bluecorona2015_content_nav( 'nav-above' ); ?>
				...
				<?php bluecorona2015_content_nav( 'nav-below' ); ?>
